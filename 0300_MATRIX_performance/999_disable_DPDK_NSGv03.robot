...
Force Tags              matrix
Documentation           Disable DPDK for MATRIX_NSGv03
Test Timeout            5 minutes

*** Test Cases ***

Enterprise Login (csproot) + Checking NSGv03 availability
    [Setup]  Csproot User is logged in VSD

    NSGv03 is up in Monitoring

Disable DPDK NSGv03 + Reload Config + Reboot
	Create NSG
	...    name=${cats_NSGv03_name}
	...    cats_nsg_template_name=MATRIX_NSGv_6P_S
	...    cats_org_name=MATRIX_ORG
	...    networkAcceleration=NONE
	
#Reload NSGv03 Configuration
	Reload NSG Configuration    
	...    cats_org_name=MATRIX_ORG
	...    cats_nsg_name=${cats_NSGv03_name}
