...
Documentation		Test case for NSG UBR1 zero factory deployment Organization B
Test Timeout		10 minutes

*** Test Cases ***

Checking NSG UBR1 availability
    [Setup]  Csproot User is logged in VSD

#	NSGUBR1 is not up in Monitoring
...
NSGUBR1 is not available
    ${id}=   Get NSG System ID
             ...    cats_org_name=${cats_org_name}
             ...    cats_nsg_name=${cats_nsg_name_ubr1}
   #Log to console    ${id} 
